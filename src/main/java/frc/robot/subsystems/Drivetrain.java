...
public class Drivetrain extends SubsystemBase {
  ...
  public Drivetrain(File directory) {
    ...
    try{
      ...
      System.out.println("RUH ROH REGGIE, NO SWERVE CONFIG");
  ...
  public Command drive(DoubleSupplier xSpeed, DoubleSupplier ySpeed, DoubleSupplier rot, boolean fieldRelative){
    ...
    return run(()->{
    Translation2d scaledInputs = SwerveMath.scaleTranslation(new Translation2d(xSpeed.getAsDouble(), ySpeed.getAsDouble()), 0.8);

    swerveDrive.drive(scaledInputs,rot.getAsDouble(),fieldRelative,false);
    });
  }

  public Command driveFieldOriented(DoubleSupplier xSpeed, DoubleSupplier ySpeed, DoubleSupplier headingX, DoubleSupplier headingY){
    swerveDrive.setHeadingCorrection(true);
    return run(()->{
    Translation2d scaledInputs = SwerveMath.scaleTranslation(new Translation2d(xSpeed.getAsDouble(), ySpeed.getAsDouble()), 0.8);
